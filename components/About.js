...
const About = () => {
  ...
  return (
    <section id='about' className="my-20 pt-4">
      ...
      <p className='text-fs2 text-darkContent dark:text-lightContext text-justify max-w-[900px] mx-auto mb-10'>
        First off, thanks for visiting my Portfolio. I am a Junior Full stack developer specializing mostly in Javascript.
        ...
        {
          expand && <p className="mt-2">As a kid I used to practice 3d modelling (using blender) but never thought I would end up coding. I started coding as a part of school curriculum and I found It so addictive :). I always consider myself to be more frontend oriented but I am also comfortable with the backend.</p>
        }
