  ...
  return (
    <motion.section 
      ...
      <p className='text-fs2 text-darkContent dark:text-lightContext text-justify max-w-[900px] mx-auto mb-10'>
        Hi there, thanks for visiting my Portfolio. I am a 20 years old Junior Full stack developer specializing mostly in Javascript.
        ...
        I am currently looking forward for an internship this summer, so I am open to communicate with any tech company that is interested.
        {
          ...
          If by any chance you are not bored made it here thank you for going through my Portfolio and Feel free to contact me any way possible, any time.</span>
        }
