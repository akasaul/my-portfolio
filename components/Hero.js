    ...
    >
      <h1 className='text-solidHeading lg:text-fs7 text-fs5 xs:text-fs6 dark:text-headerDark'>
        ...
        <span className='block hero-gradient'>
          <TypeAnimation sequence={['Nikodimos Jemaneh']} cursor={true} />
        </span>
        I build{' '}
        <span className='hero-gradient'>
          <TypeAnimation
            sequence={['Frontend', 2000, 'Backend', 2500, 'Web', 2700]}
            cursor={true}
          />
        </span>
      </h1>
      ...
      <motion.div
        ...
        className='relative z-10 image-gradient'
      >
        <Image
        ...
        lg:w-[350px] lg:h-[350px] glow
         h-[250px] object-cover rounded-[50%] z-10 sticky'
          height={1500}
          width={1500}
          alt='Nikodimos Jemaneh'
        />
      </motion.div>
    </motion.section>
  );
